...
print(f"Total of all loans ${loan_totals}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
# YOUR CODE HERE!
average_loan_price=loan_totals/total_number_of_loans
...
#    Else, the present value of the loan is less than the loan cost, then print a 
# message that says that the loan is too expensive and not worth the price.
# YOUR CODE HERE!
...
# YOUR CODE HERE!
def calculate_prsent_value(future_value, remaining_months, annual_discount_rate):
...
# YOUR CODE HERE!
present_value=calculate_prsent_value(future_value, remaining_months, 0.2)
